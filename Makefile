# Project Setup
PROJECT_NAME := configuration-azure-aks
...
uptest: $(UPTEST) $(KUBECTL) $(KUTTL)
	...
	@KUBECTL=$(KUBECTL) KUTTL=$(KUTTL) CROSSPLANE_NAMESPACE=$(CROSSPLANE_NAMESPACE) $(UPTEST) e2e examples/network-xr.yaml,examples/aks-xr.yaml --setup-script=test/setup.sh --default-timeout=2400 || $(FAIL)
